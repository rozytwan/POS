...
{
    public partial class Viewrestaurant_sales_report : UserControl
    {
        public Viewrestaurant_sales_report()
        {
            InitializeComponent();
        }
        ...
        public void CUstomerName()
        {
            ...
            {
                txt_searchText.DisplayMember = "";
                txt_searchText.ValueMember = "";
            }
        }
...

        {
            ...
            string folderPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\POS" + "\\Restaurant Sales Report\\";
        ...
        private void btn_show_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dtfis = blrr.GetFiscalYearsalesBydate2(dateOne, datetwo);
                ...
                if (cbo_searchTYpe.Text == "Item")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int inc = 0; inc < dt.Rows.Count; inc++)
                        {
                            ...
                            dataGridView1.Rows[inc].Cells["cal_tax_back"].Value = "Not Register";
                        }
                        backPanel.Show();
                        searchPanel.Hide();
                ...
                {
                    DataTable dt = blod.searchby_kot_type(txt_searchText.Text, dateOne, datetwo, fiscal_year);
                    if (dt.Rows.Count > 0)
                    {
                        dataGridView1.Rows.Clear();
                        for (int inc = 0; inc < dt.Rows.Count; inc++)
                ...
                else if (cbo_searchTYpe.Text == "Customer Name")
                {
                    DataTable dt = blod.searchby_customername(txt_searchText.Text, dateOne, datetwo, fiscal_year);
                    if (dt.Rows.Count > 0)
                    {
                        dataGridView1.Rows.Clear();
                        for (int inc = 0; inc < dt.Rows.Count; inc++)
                ...
                {
                    DataTable dt = blod.searchbybill2_for_tax(txt_searchText.Text, Convert.ToDateTime(dtp_from.Text));
                    if (dt.Rows.Count > 0)
                    {
                        dataGridView1.Rows.Clear();
                        for (int inc = 0; inc < dt.Rows.Count; inc++)
                ...
                {
                    DataTable dtm = blod.searchALL_for_tax(dateOne, datetwo, fiscal_year);
                    DataTable dt_kitchen_k1 = blod.total_kitchen_k1(dateOne, datetwo, fiscal_year);
                    DataTable dt_kitchen_k2 = blod.total_kitchen_k2(dateOne, datetwo, fiscal_year);
                    DataTable dt_kitchen_b1 = blod.total_kitchen_b1(dateOne, datetwo, fiscal_year);
                    if (dtm.Rows.Count > 0)
                    {
                        dataGridView1.Rows.Clear();
                        ...
                        if (dt_kitchen_k1.Rows.Count > 0 && dt_kitchen_k1.Rows[0]["total"].ToString() != "")
                        {
                            K1_sub_total = Convert.ToDecimal(dt_kitchen_k1.Rows[0]["total"].ToString());
                            k1Total_discount = Convert.ToDecimal(dt_kitchen_k1.Rows[0]["discount"].ToString());
                            k1Service_charge = Convert.ToDecimal(dt_kitchen_k1.Rows[0]["service_charge"].ToString());
                            k1Grand_total = Convert.ToDecimal(dt_kitchen_k1.Rows[0]["grand_total"].ToString());
                            k1Ttaxable = Convert.ToDecimal(dt_kitchen_k1.Rows[0]["tax_amount"].ToString());
                        }
                        if (dt_kitchen_k2.Rows.Count > 0 && dt_kitchen_k2.Rows[0]["total"].ToString() != "")
                        {
                            k2_sub_total = Convert.ToDecimal(dt_kitchen_k2.Rows[0]["total"].ToString());
                            k2Total_discount = Convert.ToDecimal(dt_kitchen_k2.Rows[0]["discount"].ToString());
                            k2Service_charge = Convert.ToDecimal(dt_kitchen_k2.Rows[0]["service_charge"].ToString());
                            k2Grand_total = Convert.ToDecimal(dt_kitchen_k2.Rows[0]["grand_total"].ToString());
                            k2Ttaxable = Convert.ToDecimal(dt_kitchen_k2.Rows[0]["tax_amount"].ToString());
                        }
                        if (dt_kitchen_b1.Rows.Count > 0 && dt_kitchen_b1.Rows[0]["total"].ToString() != "")
                        {
                            bot_sub_total = Convert.ToDecimal(dt_kitchen_b1.Rows[0]["total"].ToString());
                            botTotal_discount = Convert.ToDecimal(dt_kitchen_b1.Rows[0]["discount"].ToString());
                            botService_charge = Convert.ToDecimal(dt_kitchen_b1.Rows[0]["service_charge"].ToString());
                            botGrand_total = Convert.ToDecimal(dt_kitchen_b1.Rows[0]["grand_total"].ToString());
                            botTaxable = Convert.ToDecimal(dt_kitchen_b1.Rows[0]["tax_amount"].ToString());
                        }
                ...
                {
                    DataTable dt = blod.searchsale_by_serviceprovider_for_tax(txt_searchText.Text, dateOne, datetwo, fiscal_year);
                    if (dt.Rows.Count > 0)
                    {
                        dataGridView1.Rows.Clear();
                        for (int inc = 0; inc < dt.Rows.Count; inc++)
