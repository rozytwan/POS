...
{
    public partial class AddStockGrouping : UserControl
    {
        public AddStockGrouping()
        {
            InitializeComponent();
        }
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                DataTable dt = blcg.GetAllProductGrouping(id);
                if (dt.Rows.Count > 0)
                {
                    txt_group_name.Text = dt.Rows[0]["group_name"].ToString();

                    string category_color_chk = dt.Rows[0]["group_color"].ToString();
                    if (category_color_chk != null && category_color_chk != "")
                    {
                        btn_darkblue.Image = null;
                        string category_color = dt.Rows[0]["group_color"].ToString();
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            {
                int update = blcg.UpdateStockGrouping(id, txt_group_name.Text, color);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            {
                int insert = blcg.InsertStockGrouping(txt_group_name.Text, color);
                if (insert > 0)
                {
                    MessageBox.Show("Successfully Inserted Alert !!", "Success !!!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    refresh();
                }
            }
        }
