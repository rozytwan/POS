...
namespace POS_System.Printing_KOT
{
   public class BakeryKOTPriting80
    {
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (dt_printing_set.Rows.Count > 0)
            {
                ...
                if (service_type == "TA")
                {
                    ...
                    gra.DrawString("Take Away: ", new System.Drawing.Font("Arial", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, ys);
                    gra.DrawString(table_no, new System.Drawing.Font("Arial", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, ys);
                }
                else
                {

                    gra.DrawString("Home Delivery:", new System.Drawing.Font("Arial", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, ys);
                    gra.DrawString(table_no, new System.Drawing.Font("Arial", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, ys);
                }
