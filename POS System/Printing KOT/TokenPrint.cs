  ...
  public class TokenPrint
    {
        ...
        public void printkot()
        {
            ...
            pd.Document = pdoc;
            pdoc.PrinterSettings.PrinterName = "U";
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            Font drawFontToken = new Font("Arial", 15, FontStyle.Regular);
            ...
            if (dt_printing_set.Rows.Count > 0)
            {
                ...
                if (dt_printing_set.Rows[0]["address"].ToString() == "True")
                {
                    ...
                    e.Graphics.DrawString("Token No", drawFontToken, drawBrush, new RectangleF(xs, ys, widths, heights), drawFormatCenter);
                    ys += e.Graphics.MeasureString("Token No", drawFontToken).Height; ys = ys + 18;
                    e.Graphics.DrawString(table_no, drawFontToken, drawBrush, new RectangleF(xs, ys, widths, heights), drawFormatCenter);
                    ys += e.Graphics.MeasureString(table_no, drawFontToken).Height; ys = ys + 18;
                ...
                if (dt_printing_set.Rows[0]["header"].ToString() == "True")
                {
                    ...
                    gra.DrawLine(drawingPen, 0, ys, 309, ys); ys = ys + 2;
                    gra.DrawString("Item", new System.Drawing.Font("Arial", 9, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 0, ys);
                    gra.DrawString("Qty", new System.Drawing.Font("Arial", 9, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 250, ys); ys = ys + 13;
                    ...
                    if (dt_printing_set.Rows[0]["items"].ToString() == "True")
                    {
                        ...
                        {
                            if (datagridview_kot_print[i] == "K1")
                            {
