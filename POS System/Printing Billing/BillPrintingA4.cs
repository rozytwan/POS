            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                if (getalltable.Rows[0]["received_amt"].ToString() == "True")
                {
                    ...
                    if (billing_print_only == true)
                    {
                        ...
                        {
                            gra.DrawString("Advance AMT ::", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 300, y );
                    ...
                    {
                        gra.DrawString("Received AMT ::", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 300, y );
                ...
                {
                    gra.DrawString("Change AMT :", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 300, y );
