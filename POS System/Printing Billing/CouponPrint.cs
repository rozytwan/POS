   ...
   public class CouponPrint
    {
        ...
        private void printDocument1s_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                //    else
                //    {
                //        e.Graphics.DrawString("Coupon", drawFontArial10Regular, drawBrush, new RectangleF(xs, ys + ybinc + yinc, widths, heights), drawFormatCenter);
                //        ys += e.Graphics.MeasureString("Coupon", drawFontArial10Regular).Height;
                ...
                if (billing_print_only != true)
                {
                    ...
                    gra.DrawString("S.ID:", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, y + ybinc + yinc);
                    gra.DrawString(bill_no, new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 120, y + ybinc + yinc);
                    y = y + 13;
                }
                ...
                if (getalltable.Rows[0]["table_name"].ToString() == "True")
                {
                    ...
                    gra.DrawString("Token No :", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, y + ybinc + yinc);
                ...
                if (getalltable.Rows[0]["cashier"].ToString() == "True")
                {
                    ...
                    gra.DrawString(cashier, new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 105, y + ybinc + yinc);
                    y = y + 13;
                    gra.DrawString("Service Provider :", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, y + ybinc + yinc);
                    gra.DrawString(service_provider, new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 105, y + ybinc + yinc);
                    y = y + 13;
                }
                ...
                if (getalltable.Rows[0]["discount"].ToString() == "True")
                {
                    ...
                    gra.DrawLine(drawingPen, 120, y + yinc + ybinc, 250, y + yinc + ybinc); y = y + 2;
                }
