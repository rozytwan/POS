...
{
    public class PANBillPrinting80
    {
        ...
        public void printtobill()
        {
            ...
            {
                pdoc.PrintPage += new PrintPageEventHandler(PrintPANDoc56);
            }
        ...
        private void printDocument1s_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                if (billing_print_only != true)
                {
                    gra.DrawString("PAN No :", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, 73 + ybinc + yinc);
                ...
                {
                    gra.DrawString("Sub-Total :", new System.Drawing.Font("Courier New ", 8, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 120, y + yinc + ybinc);
                ...
                gra.DrawString("Grand Total:", new System.Drawing.Font("Courier New ", 18, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 10, y + yinc + ybinc);
                ...
                if (getalltable.Rows[0]["change_amt"].ToString() == "True")
                {
                    ...
                    gra.DrawString(change_amount, new System.Drawing.Font("Courier New ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 220, y + yinc + ybinc); y = y + 20;
                }
                ...
                if (FooterStatus == true)
                {
                    ...
                    gra.DrawString("Customer", new System.Drawing.Font("Time New Roamn", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 205, y); y = y + 15;
                    if (billing_print_only == true)
                    {
        ...
        private void PrintPANDoc56(object sender, PrintPageEventArgs e)
        {
            ...
            int yinc = 0;
            int ybinc = 0;
            float widths = 150.0F; // max width I found through trial and error
            float heights = 0F;
            string price;
            string name; string quantity; string totala; int y = 83;
            Pen drawingPen = new Pen(Color.Black, 1);
            Pen draw_watermark = new Pen(Color.FromArgb(40, Color.Black));
            Font drawFontArial12Bold = new Font("Arial", 8, FontStyle.Bold);
            Font drawFontArial10Regular = new Font("Arial", 7, FontStyle.Regular);
            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                if (Headerstatus == true)
                {
                    if (getalltable.Rows[0]["store_name"].ToString() == "True")
                    {
                        e.Graphics.DrawString(business_name, drawFontArial12Bold, drawBrush, new RectangleF(xs, ys, widths, heights), drawFormatCenter);
                        ys += e.Graphics.MeasureString(business_name, drawFontArial12Bold).Height;
                        if (business_name.Length >= 22)
                        {
                            ybinc = 17;
                        }
                        if (business_name.Length >= 44)
                        {
                            ybinc += 17;
                        }
                    }
                    if (getalltable.Rows[0]["address"].ToString() == "True")
                    {
                        ...
                        if (duplicate_bill_print == true)
                        {
                            gra.DrawString("Copy Of Orginal #" + count_print, new System.Drawing.Font("Times New Roman ", 10, FontStyle.Bold), new SolidBrush(Color.FromArgb(64, Color.Black)), 40, 20 + ybinc + yinc);
                        }
                ...
                if (billing_print_only != true)
                {
                    gra.DrawString("PAN:", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, 73 + ybinc + yinc);
                    gra.DrawString(pan_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, 73 + ybinc + yinc);
                    gra.DrawString("Bill No :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    gra.DrawString(bill_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, y + ybinc + yinc);
                    y = y + 13;
                }
                ...
                if (getalltable.Rows[0]["table_name"].ToString() == "True")
                {
                    ...
                    if (sales_type == "HD")
                    {
                        gra.DrawString("HD No :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    }
                    else if (sales_type == "TA")
                    {
                        gra.DrawString("TA :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);

                    }
                    else
                    {

                        gra.DrawString("Table No :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    }
                    gra.DrawString(table_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, y + ybinc + yinc);
                    y = y + 13;
                    if (table_name != null && table_name != "")
                    {
                        gra.DrawString("Table Name :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                        gra.DrawString(table_name, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, y + ybinc + yinc);
                        y = y + 13;
                    }
                }
                if (getalltable.Rows[0]["date_and_time"].ToString() == "True")
                {
                    ...
                    gra.DrawString(String.Format("{0:f}", billing_date), new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    y = y + 13;
                    gra.DrawString(nepaliDate, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    y = y + 13;
                    gra.DrawString("Fiscal Year :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    gra.DrawString(fiscal_year, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, y + ybinc + yinc);
                    y = y + 13;
                }
                if (getalltable.Rows[0]["cashier"].ToString() == "True")
                {

                    gra.DrawString("Cashier :", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    gra.DrawString(cashier, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 60, y + ybinc + yinc);
                    y = y + 13;
                }
                ...
                if (getalltable.Rows[0]["header"].ToString() == "True")
                {
                    gra.DrawLine(drawingPen, 0, y + ybinc + yinc, 314, y + ybinc + yinc);
                    y = y + 5;
                    gra.DrawString("Item", new System.Drawing.Font("Arial", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    gra.DrawString("QTY", new System.Drawing.Font("Arial", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 120, y + ybinc + yinc);
                    gra.DrawString("Total", new System.Drawing.Font("Arial", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 160, y + ybinc + yinc);
                    y = y + 13;
                    gra.DrawLine(drawingPen, 0, y + ybinc + yinc, 314, y + ybinc + yinc);
                    y = y + 5;
                }
                if (getalltable.Rows[0]["items"].ToString() == "True")
                {
                    for (int i = 0; i < datagridview_item_name.Count; i++)
                    {
                        ...
                        if (name.Length <= 20)
                        {
                            ...
                            gra.DrawString(name, new System.Drawing.Font("Time New Roamn", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);

                        }
                        else
                        {
                            string sub = name.Substring(0, 20);
                            gra.DrawString(sub + "...", new System.Drawing.Font("Time New Roamn", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                        ...
                        if (print_again != true)
                        {
                            //gra.DrawString(datagridview_complementary[i], new System.Drawing.Font("Time New Roamn", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 90, y + yinc + ybinc);
                        }
                        gra.DrawString(quantity, new System.Drawing.Font("Time New Roamn", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 120, y + yinc + ybinc);

                        gra.DrawString(totala, new System.Drawing.Font("Time New Roamn", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 155, y + yinc + ybinc);
                        y = y + 20;
                    }
                }
                ...
                if (getalltable.Rows[0]["sub_total"].ToString() == "True")
                {
                    gra.DrawString("Sub-Total :", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                    gra.DrawString(sub_total, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 155, y + yinc + ybinc); y = y + 16;
                    gra.DrawLine(drawingPen, 60, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                }
                if (getalltable.Rows[0]["discount"].ToString() == "True")
                {
                    if (discount != "")
                    {
                        gra.DrawString("Discount(" + discount_percent + ")", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                        gra.DrawString(discount, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 155, y + yinc + ybinc); y = y + 16;
                        gra.DrawLine(drawingPen, 60, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                    }
                    gra.DrawLine(drawingPen, 145, y + yinc , 145, y + yinc  + 72); //xline stright
                 
                    gra.DrawString("Total", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                    gra.DrawString(discount_sub_total, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 155, y + yinc + ybinc); y = y + 16;
                    gra.DrawLine(drawingPen, 60, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                    if (sales_type != "HD" || service_charge != "")
                    {
                        gra.DrawString("Service (" + service_charge_percent + "%)", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                        gra.DrawString(service_charge, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 155, y + yinc + ybinc); y = y + 16;
                    }
                    gra.DrawLine(drawingPen, 60, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                }
                ...
                gra.DrawLine(drawingPen, 0, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                gra.DrawString("Grand Total:", new System.Drawing.Font("Courier New ", 12, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 0, y + yinc + ybinc);
                gra.DrawString(grand_total, new System.Drawing.Font("Courier New ", 12, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 95, y + yinc + ybinc); y = y + 40;
                gra.DrawLine(drawingPen, 0, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                //string inwordtext = Spell.SpellAmount.InWrods(Convert.ToDecimal(Convert.ToDecimal(grand_total).ToString("F")));
                //e.Graphics.DrawString("In Words:" + inwordtext.Substring(4, inwordtext.Length - 4), drawFontArial10Regular, drawBrush, new RectangleF(xs, y + yinc + ybinc, widths, heights), drawFormatCenter);
                //ys += e.Graphics.MeasureString("In Words:" + inwordtext.Substring(4, inwordtext.Length - 4), drawFontArial10Regular).Height; y = y + 50;
               // gra.DrawLine(drawingPen, 0, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                if (getalltable.Rows[0]["received_amt"].ToString() == "True")
                {
                    ...
                    if (billing_print_only == true)
                    {
                        if (cash_amount != "0.00" || cash_amount != "0" || cash_amount != "")
                        {
                            gra.DrawString("Advance AMT ::", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 100, y + yinc + ybinc);
                            gra.DrawString(cash_amount, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 160, y + yinc + ybinc); y = y + 16;
                        }

                    }
                    else
                    {
                        gra.DrawString("Received AMT ::", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                        gra.DrawString(cash_amount, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 150, y + yinc + ybinc); y = y + 16;
                    }
                }
                if (getalltable.Rows[0]["change_amt"].ToString() == "True")
                {
                    gra.DrawString("Change AMT :", new System.Drawing.Font("Courier New ", 7, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 60, y + yinc + ybinc);
                    gra.DrawString(change_amount, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 150, y + yinc + ybinc); y = y + 30;
                }

                if (FooterStatus == true)
                {
                    e.Graphics.DrawString(note_1, drawFontArial12Bold, drawBrush, new RectangleF(xs, y + yinc + ybinc, widths, heights), drawFormatCenter);
                    ys += e.Graphics.MeasureString(note_1, drawFontArial12Bold).Height; y = y + 13;
                    if (note_1.Length > 40)
                    {
                        y = y + 13;
                    }
                    gra.DrawString(note_2, new System.Drawing.Font("Courier New ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + yinc + ybinc);
                    if (note_2.Length > 40)
                    {
                        y = y + 13;
                    }
                    ...
                    if (customer_name != "Choose One" && customer_name != "" && customer_name != null)
                    {
                        gra.DrawString("C.Name #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                        if (customer_name.Length > 30)
                        {

                            gra.DrawString(customer_name.Substring(0, 29), new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 70, y + ybinc + yinc);
                            y = y + 15;
                            gra.DrawString(customer_name.Substring(30), new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 70, y + ybinc + yinc);
                            y = y + 15;

                        }
                        else
                        {
                            gra.DrawString(customer_name, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, y + ybinc + yinc);
                            y = y + 15;
                        }
                        if (payment_mode == "Club Card")
                        {
                            gra.DrawString("Club Card No #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                            gra.DrawString(customer_PAN_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 100, y + ybinc + yinc);
                            y = y + 15;
                            gra.DrawString("Card Balance #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                            gra.DrawString(customer_card_balance, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 100, y + ybinc + yinc);
                            y = y + 15;
                        }
                        else
                        {
                            gra.DrawString("C.PAN No #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                            gra.DrawString(customer_PAN_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 70, y + ybinc + yinc);
                            y = y + 15;
                        }
                        if (customer_address != "")
                        {
                            gra.DrawString("C.Address #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                            gra.DrawString(customer_address, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 70, y + ybinc + yinc);
                            y = y + 15;
                        }
                        if (customer_phone_no != "")
                        {
                            gra.DrawString("C.Phone No #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                            gra.DrawString(customer_phone_no, new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 70, y + ybinc + yinc);
                            y = y + 15;
                        }
                    ...
                    //    //// res.Dump(); // 
                    //    //gra.DrawString("Service No #", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                    //    //gra.DrawString(kid, new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 130, y + ybinc + yinc);
                    //    //y = y + 15;
                    //}
                    if (billing_print_again == true)
                    {
                        gra.DrawString("Re-Print Date #", new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                        gra.DrawString(String.Format("{0:f}", strDate), new System.Drawing.Font("Times New Roman ", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, y + ybinc + yinc);
                        y = y + 15;
                    }
                    y = y + 50;
                    gra.DrawLine(drawingPen, 0, y, 80, y); y = y + 3;
                    gra.DrawString("Cashier", new System.Drawing.Font("Time New Roamn", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y);


                    //signature line2 
                    gra.DrawLine(drawingPen, 200, y, 300, y); y = y + 3;
                    gra.DrawString("Customer", new System.Drawing.Font("Time New Roamn", 9, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, y); y = y + 15;
                    if (billing_print_only == true)
                    {
                        e.Graphics.DrawString("This Quotation is not for official use.", drawFontArial10Regular, drawBrush, new RectangleF(xs, y, widths, heights), drawFormatCenter);
                        ys += e.Graphics.MeasureString("This Quotation is not for official use.", drawFontArial10Regular).Height; y = y + 15;
