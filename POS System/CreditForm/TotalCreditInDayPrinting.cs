...
{
    public class TotalCreditInDayPrinting
    {
        ...
        private void printDocument1s_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            gra.DrawString(String.Format("{0:f}",Convert.ToDateTime(DateTime.Now.ToLongDateString())), new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 80, y + ybinc + yinc);
            y = y + 13;
            ...
            gra.DrawString("Bill No", new System.Drawing.Font("Arial", 8, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 170, y + ybinc + yinc);
            gra.DrawString("Total Credit", new System.Drawing.Font("Arial", 8, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 220, y + ybinc + yinc);
            y = y + 13;
            gra.DrawLine(drawingPen, 0, y + ybinc + yinc, 314, y + ybinc + yinc);
            y = y + 5;
            ...
            {
                string custome_name = dt.Rows[i]["name"].ToString();
                string bill_no = dt.Rows[i]["bill_no"].ToString();
                string total_credit = dt.Rows[i]["credit_amount"].ToString();
                gra.DrawString(custome_name, new System.Drawing.Font("Time New Roamn", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 0, y + ybinc + yinc);
                gra.DrawString(bill_no, new System.Drawing.Font("Time New Roamn", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 170, y + ybinc + yinc);
                gra.DrawString(total_credit, new System.Drawing.Font("Time New Roamn", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 220, y + ybinc + yinc);
                y = y + 15;
            }
