...
{
    public partial class ViewOrderCancelForm : UserControl
    {
        public ViewOrderCancelForm()
        {
            InitializeComponent();
        }
        ...
        private void btn_show_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DateTime datetwo = Convert.ToDateTime(dtp_to.Text+ " 23:59:00");
                if (cbo_searchTYpe.Text == "Category")
                {
                    DataTable getdt = boc.getbycategory(txt_searchText.Text, dateOne, datetwo);
                ...
                {
                    DataTable getdt = boc.getbyitems(txt_searchText.Text, dateOne, datetwo);
                    if (getdt.Rows.Count > 0)
                    {
                ...
                else if (cbo_searchTYpe.Text == "ALL")
                {
                    ...
                    DataTable getdt = boc.getallCancelOrdersbydates(dateOne, datetwo);
                    if (getdt.Rows.Count > 0)
                    {
                ...
                else if (cbo_searchTYpe.Text == "Sales Type")
                {
                    ...
                    DataTable getdt = boc.getby_sales_type(txt_searchText.Text, dateOne, datetwo);
                    if (getdt.Rows.Count > 0)
                    {
