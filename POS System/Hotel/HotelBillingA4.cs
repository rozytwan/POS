  ...
  public class HotelBillingA4
    {
        ...
        public void printtobill()
        {
            ...
            PaperSize psize = new PaperSize("Custome", 830, 3600);
            pd.Document = pdoc;
            pdoc.PrinterSettings.PrinterName = "BillingA4";
        ...
        private void printDocument1s_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                {
                    gra.DrawString("Customer Name #", new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 450, y);
                    if (customer_name.Length > 30)
                    {
                        gra.DrawString(customer_name.Substring(0, 29), new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 580, y);
                        y = y + 16;
                        gra.DrawString(customer_name.Substring(29), new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 580, y);
                        y = y + 16;

                    }
                    else
                    {
                        gra.DrawString(customer_name, new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 580, y);
                        y = y + 16;
                    }
                }
                else
                ...
                if (customer_PAN_no != "")
                {
                    gra.DrawString("Customer PAN No #", new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 450, y);
                    gra.DrawString(customer_PAN_no, new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 580, y);
                    y = y + 16;
                }
                else
                {
                ...
                {
                    gra.DrawString("Customer Address #", new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 450, y);
                    gra.DrawString(customer_address, new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 580, y);
                    y = y + 16;
                ...
                {
                    gra.DrawString("Customer Phone No #", new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 450, y);
                    gra.DrawString(customer_phone_no, new System.Drawing.Font("Times New Roman ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 590, y);
                    y = y + 19;
                ...
                if (getalltable.Rows[0]["header"].ToString() == "True")
                {
                    ...
                    gra.DrawString("QTY", new System.Drawing.Font("Arial", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 550, y);
                    gra.DrawString("Price", new System.Drawing.Font("Arial", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 650, y);
                    gra.DrawString("Total", new System.Drawing.Font("Arial", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 750, y);
                    y = y + 16;
                    gra.DrawLine(drawingPen, 0, y, 890, y);
                    y = y + 7;
                }
                if (getalltable.Rows[0]["items"].ToString() == "True")
                {
                    ...
                    for (int i = 0; i < totalItem; i++)
                    {
                        ...
                        if (name == "Room Charge")
                        {
                            gra.DrawString(quantity + " days", new System.Drawing.Font("Time New Roamn", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 540, y );
                            gra.DrawString(price, new System.Drawing.Font("minisystem", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 640, y);
                            gra.DrawString(totala, new System.Drawing.Font("minisystem", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 740,y);
                            y = y + 20;
                            gra.DrawLine(drawingPen, 520, y, 890, y);
                            y = y + 2;
                            gra.DrawString("Total :", new System.Drawing.Font("minisystem", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 640, y);
                            gra.DrawString(totala, new System.Drawing.Font("minisystem", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 740, y); y = y + 16;
                ...
                {
                    gra.DrawString("Discount(" + discount_percent + ")", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 500, y);
                    gra.DrawString(discount, new System.Drawing.Font("Courier New ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 600, y); y = y + 19;
                    gra.DrawLine(drawingPen, 590, y, 590, y + 72); //xline stright
                    gra.DrawLine(drawingPen, 490, y, 890, y); y = y + 2;

                    gra.DrawString("Total", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 500, y);
                    gra.DrawString(discount_sub_total, new System.Drawing.Font("Courier New ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 600, y); y = y + 19;

                    gra.DrawLine(drawingPen, 490, y, 890, y); y = y + 2;
                    if (sales_type != "HD")
                    {
                        gra.DrawString("Service (" + service_charge_percent + "%)", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 500, y);
                        gra.DrawString(service_charge, new System.Drawing.Font("Courier New ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 600, y); y = y + 19;
                    }
                    gra.DrawLine(drawingPen, 490, y, 890, y); y = y + 2;
                ...
                {
                    gra.DrawString("Taxable AMT", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 500, y);
                    gra.DrawString(taxable_amount, new System.Drawing.Font("Courier New ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 600, y); y = y + 19;

                    gra.DrawLine(drawingPen, 490, y, 890, y); y = y + 2;
                    gra.DrawString("VAT (" + String.Format("{0:0.##}", tax_percent) + "%)", new System.Drawing.Font("Courier New ", 10, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 500, y);
                    gra.DrawString(tax_amount, new System.Drawing.Font("Courier New ", 10, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 600, y); y = y + 19;
