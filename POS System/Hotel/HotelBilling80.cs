       ...
       public string printer_name;
        ...
        private void printDocument1s_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if (getalltable.Rows.Count > 0)
            {
                ...
                {
                    gra.DrawString("Room :", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, y + ybinc + yinc);
                    ...
                    y = y + 13;
                    gra.DrawString("Room No :", new System.Drawing.Font("Times New Roman ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 10, y + ybinc + yinc);
                ...
                if (getalltable.Rows[0]["items"].ToString() == "True")
                {
                    ...
                    for (int i = 0; i < datagridview_item_name.Count; i++)
                    {
                        ...
                        if (name == "Room Charge")
                        {
                            gra.DrawString(quantity+" days", new System.Drawing.Font("Time New Roamn", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 140, y + yinc + ybinc);
                            gra.DrawString(price, new System.Drawing.Font("minisystem", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 180, y + yinc + ybinc);
                            gra.DrawString(totala, new System.Drawing.Font("minisystem", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 230, y + yinc + ybinc);
                            y = y + 13;
                            gra.DrawLine(drawingPen, 0, y + ybinc + yinc, 314, y + ybinc + yinc);
                            y = y + 2;
                            gra.DrawString("Total :", new System.Drawing.Font("minisystem", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 180, y + yinc + ybinc);
                            gra.DrawString(totala, new System.Drawing.Font("minisystem", 7, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 230, y + yinc + ybinc); y = y + 16;
                ...
                {
                    gra.DrawString("Taxable AMT", new System.Drawing.Font("Courier New ", 8, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 120, y + yinc + ybinc);
                    gra.DrawString(taxable_amount, new System.Drawing.Font("Courier New ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 220, y + yinc + ybinc); y = y + 16;
                    gra.DrawLine(drawingPen, 120, y + yinc + ybinc, 314, y + yinc + ybinc); y = y + 2;
                    gra.DrawString("VAT (" + String.Format("{0:0.##}", tax_percent) + "%)", new System.Drawing.Font("Courier New ", 8, FontStyle.Bold), new SolidBrush(System.Drawing.Color.Black), 120, y + yinc + ybinc);
                    gra.DrawString(tax_amount, new System.Drawing.Font("Courier New ", 8, FontStyle.Regular), new SolidBrush(System.Drawing.Color.Black), 220, y + yinc + ybinc); y = y + 16;
                }
